...
void Engine::prepareTriangle() {
    GLenum glew_error = glewInit();
    if (glew_error != GLEW_OK)
    {
        std::cout << "GLEW Error: " << glewGetErrorString(glew_error);
        exit(1);
    }
    ...
    std::ifstream fpv("C:\\Users\\river\\Documents\\Newbie\\Custom\\Shaders\\vert.glsl");
    ...
    std::ifstream fpf("C:\\Users\\river\\Documents\\Newbie\\Custom\\Shaders\\frag.glsl");
